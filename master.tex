...
% INDLEDNING
	\include{incl/main/indledning/forord}
	\include{incl/main/indledning/indledning}
	
% LINEÆR ALGEBRA 
	% Matricer og vektorer
	\include{incl/main/linear_algebra/linear_algebra}
...
% LINEÆR OPTIMERINGSPROBLEMER 
	...
	\include{incl/main/linear_optimeringsproblemer/generalt}
	% Standartform 
	\input{incl/main/linear_optimeringsproblemer/standardform}
	% Slack varialbe 
	\input{incl/main/linear_optimeringsproblemer/slack_variable}
	% Dualitet 
	\input{incl/main/linear_optimeringsproblemer/dualitet}
	
% GEOMETRISK FREMSTILLING 
	\include{incl/main/grafisk_losning/grafisk_losning}	

% SIMPLEX METODEN
	\include{incl/main/simplex_metoden/simplex_metoden}	

% LU - DEKOMPOSITION 
	\include{incl/main/lu_dekomposition/lu_dekomposition}
