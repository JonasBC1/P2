...
% -------------------------------------------------------
\filldraw [black] (3,1.5) circle (0pt) node[right] {$ \{ \mathbf{y} \mid \mathbf{c}_{\textbf{w}}^T \mathbf{y} = \mathbf{c}_{\textbf{w}}^T \mathbf{x} \}$};
\filldraw [black] (x) circle (2pt) node[above] {$\mathbf{x}$};
\filldraw [black] (-1,4.5) circle (0pt) node[left] {$ \{ \mathbf{y} \mid \mathbf{c}_{\textbf{x}}^T \mathbf{y} = \mathbf{c}_{\textbf{x}}^T \mathbf{w} \}$};
