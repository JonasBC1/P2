...
\documentclass[12pt,a4paper,oneside,openright,danish]{book}

% Variabler, som bruges til automatisk at indsætte titel, forfattere, osv. på
% forsiden og titelbladet.
\def \projecttitle       {Eksamensopgaver-OPG2}
\def \projectsubtitle    {Computerstøttede beregninger}
\def \projecttheme       {CSB}
