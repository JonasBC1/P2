...
\begin{frame}{Lagrange-interpolation}
    \begin{itemize}
        \item Lagrange-interpolation finder et polynomium $p(x_k)=f(x_k)$ af mindst mulig grad % og er således en måde at approksimere en funktionsværdi givet $x_0 \ldots x_N$ og $N+1 $  $y$ værdier.
