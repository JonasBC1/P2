...
\addplot[fill=myblue!15,opacity=0.4] fill between [of=d and b, soft clip={domain=0:2}];
\addplot[fill=myblue!15,opacity=0.4] fill between [of=d and a, soft clip={domain=2:4}];
...
\end{tikzpicture}
\caption{Grafisk illustration, hvor den optimale løsning er $\infty$ til problemet i \ref{eks:min_loes}.}
%
