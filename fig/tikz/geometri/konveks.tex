...
%
\filldraw[black] (0.8,0.85,1.2) circle (0.2pt) node[left] {$\mathbf{x}$};
\filldraw[black] (1.1,0.85,1.2) circle (0.2pt) node[right] {$\mathbf{y}$};
%
% Rød figur 
\draw[thick,-] (1.6,0.85,1.2) -- (1.9,0.85,1.2);
%
\filldraw[black] (1.6,0.85,1.2) circle (0.2pt) node[left] {$\mathbf{x}$};
\filldraw[black] (1.9,0.85,1.2) circle (0.2pt) node[right] {$\mathbf{y}$};
%
%
\end{tikzpicture}
