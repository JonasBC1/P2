...
%
\end{tikzpicture}
  \captionof{figure}{Vektorerne $\mathbf{u}$ og $ \mathbf{v}$, samt den konvekse kombination af dem, hvor $\lambda_{\textbf{u}} = \lambda_{\textbf{v}} = \frac{1}{2}$, og det konvekse hylster af vektorerne, der er markeret med blå.}
  \label{fig:neej2}
\end{center}
%