...
%
\end{tikzpicture}
  \captionof{figure}{Vektorerne $\mathbf{x}$ og $ \mathbf{y}$, samt den konvekse kombination af dem, hvor $\lambda_x = \lambda_y = \frac{1}{2}$, og det konvekse hylster af vektorerne, der er markeret med blå.}
  \label{fig:neej2}
\end{center}
%