...
% -------------------------------------------------------
% a_1
\draw[gray,thick,dashed](0.7,0.5,1.2)--(0.7,1.5,1.2);
...
%
\end{tikzpicture}
  \captionof{figure}{Fællesmængden for den øvre halvrum for hyperplanerne udgør polyeden $\mathcal{P}$ markeret med blå i $\R^2$.}
  \label{fig:nej5}
\end{center}