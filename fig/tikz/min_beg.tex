...
\begin{axis}[
	...
	xlabel = $x_1$,
	ylabel = {$x_2$},
	legend style={at={(1.02,0)},anchor=south west},
]
	\addplot[name path=a, domain={0:13.5}, samples=2]{x-7};
	\addplot[name path=b, domain={0:1}, samples=2]{2*x+10};
	
	\addplot[name path=c, domain={1:8}, samples=2]{12};
