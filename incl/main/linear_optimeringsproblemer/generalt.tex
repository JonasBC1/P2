...
\end{align*}
%
hvor $\textbf{c}^T\textbf{x}$ er objektfunktionen, \textcolor{red}{$z$ er omkostningen} og $\textbf{a}^T\textbf{x}$ er de lineære betingelser, samt $M_1, M_2, M_3, N_1, N_2$ er endelige mængder med indekser.
