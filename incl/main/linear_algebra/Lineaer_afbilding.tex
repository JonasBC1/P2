...
%Synes ovenstående er unødvendigt, så har udkommenteret det. 
\begin{defn}{}{}
...
%
\begin{proof}
Lad $\textbf{u}, \textbf{v}$ være vektorer i $\R^n$, $c$ og $k$ være skalarer og lad $T: \R^n \rightarrow \R^m$ være en lineær transformation.
...
\end{align*}
%
Trækkes $T(\textbf{0})$ fra begge sider haves, at $\textbf{0} = T(\textbf{0})$, hvilket viser det ønskede.
%
