...
\end{align*}
%
\item Ved kombination af, at $T$ bevarer vektor addition og (b), haves, at
%
\begin{align*}
T(\textbf{u}-\textbf{v}) = T(\textbf{u}+(-\textbf{v})) = T(\textbf{u})+T(-\textbf{v}) = T(\textbf{u}) - T(\textbf{v}).
\end{align*}
%
\item Da $T$ både bevarer både vektor addition og skalering haves, at 
%
\begin{align*}
...
%
\begin{proof}
Lemmaet følger direkte af \ref{thm:afbegen}.
\end{proof}
\\
%
