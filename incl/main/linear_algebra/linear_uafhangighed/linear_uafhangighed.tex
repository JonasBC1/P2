...
En mængde af vektorer $\mathbf{u}_1, \mathbf{u}_2, \ldots , \mathbf{u}_k \in \R^n$ kaldes lineært uafhængige, hvis der for alle skalarer $x_1, x_2, \ldots , x_k$, sådan at ligningen 
\begin{align*}
