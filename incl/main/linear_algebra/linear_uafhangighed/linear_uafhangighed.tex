...
En mængde af vektorer $\mathbf{v}_1, \mathbf{v}_2, \ldots , \mathbf{v}_k \in \R^n$ kaldes lineært uafhængige, hvis der eksisterer skalarer $x_1, x_2, \ldots , x_k$, sådan at ligningen 
\begin{align*}
...
\end{align*}
%
Lad $i$ være det største index $i$, hvor $c_i \neq 0$, sådan at 
\begin{align*}
...
\begin{align*}
\textbf{u}_1 -c_1\textbf{u}_1 - c_2\textbf{u}_2 - \cdots - c_{i-1}\textbf{u}_{i-1} = \textbf{0}
\end{align*} 
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Det kan i nogle tilfælde afgøres ved inspektion, hvorvidt en mængde vektorer $\mathbf{v},\mathbf{v}_2,\ldots ,\mathbf{v}_k$ er lineært afhængige. 
