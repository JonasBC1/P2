...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Man kan i nogle tilfælde afgøre ved inspektion, hvorvidt en mængde vektorer $\mathbf{v},\mathbf{v}_2,\ldots ,\mathbf{v}_k$ er lineær afhængige. 
...
\\\\
Hvis man ikke ved hjælp af inspektion kan afgøre, hvorvidt en matrix er lineært afhængig eller lineært uafhængig, kan det undersøges ved at opstille totalmatricen af mængden af vektorer, hvor det derefter med rækkeopperationer laves på trappeform. 
...
\noindent
%
Hvis vektorerne er lineært uafhængige, altså hvis $x_1 = x_2 = x_3= 0$, er den eneste løsning til linearkombination
%
\begin{align*}
x_1+
\begin{bmatrix}
