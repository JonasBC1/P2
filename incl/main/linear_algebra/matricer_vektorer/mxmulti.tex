...
\end{eks}
Da matricen $B$ inddeles i søjlevektorer, er grundprincippet i matrixmultiplikation at finde matrix-vektorprodukter.
...
Det følger deraf, at $(A+B)\textbf{c}_j=A\textbf{c}_j+B\textbf{c}_j$ jævnfør \ref{thm:mxvpro}(c).
% 
\item  Lad $\textbf{p}_j$ og $\textbf{q}_j$ være søjler i henholdsvis $P$ og $Q$. Det følger deraf, at $C(\textbf{p}_j+\textbf{q}_j)=C\textbf{p}_j+C\textbf{q}_j$ jævnfør \ref{thm:mxvpro}(a). 
%
