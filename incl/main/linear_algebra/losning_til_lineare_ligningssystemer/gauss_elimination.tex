...
\item Skab nuller under pivot-indgangen ved hjælp af rækkeudskiftning.
...
\end{align*}
%
Ligningssystemet opskrevet som totalmatrix $[A \text{   }|\text{ }\mathbf{b}]$.
%
\begin{equation*}
A=
...
% 
For at beskrive en matrix egenskaber i forhold til pivot-indgange er der brug for at definere nogle begreber. 
%
\begin{defn}{}{}
...
Såfremt $(c)$ er sandt gælder omvendt, at alle rækker i den reducerede trappeform indeholder en løsning, som også er løsning til $A\mathbf{x}=\mathbf{b}$. 
