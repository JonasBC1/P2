...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
Typisk bruges spannet til at undersøge, hvorvidt en given vektor er en linearkombination af en vektormængde. 
...
\begin{proof}
%
Udsagn (a) og (b) er ækvivalente, eftersom det er en forudsætning, at der kan skabes en linearkombination af $A\mathbf{x} =\mathbf{b}$ for ethvert $\mathbf{b}$ i $\R^m$, da det netop er definitionen af spannet, der dækker $\R^m$. 
%
...
Lad $B$ være den reducerede trappeform af $A$ og
%
\begin{align*}
...
Da disse rækkeoperationer er reversible, følger det, at der findes en sekvens af rækkeoperationer, som kan transformere $B$ til $A$.
...
Det følger derfor af \ref{thm:konsistens}, at den sidste række ikke kan være en nulrække, da standardvektoren $\mathbf{e}_m$ har pivotindgang i sidste søjle, er ligningssystemet inkonsistent.
...
Derfor kan $[B \mid \mathbf{c}]$ ikke indeholde en nulrække, og der er derfor ikke pivot i sidste søjle.
