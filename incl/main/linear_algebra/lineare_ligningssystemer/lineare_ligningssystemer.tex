...
$
\end{center}
i $\R ^n$, således at alle ligninger er opfyldt, når $x_i$ erstattes med $s_i$. Et eksempel på et lineært ligningssystem ses i eksempel \ref{eks:lignsys}.
%
\\
\begin{eks}
\label{eks:lignsys}
...
\textit{Totalmatrixen} $[A \text{    } | \mathbf{b}]$ dannes ved at kombinere koefficientmatricen med vektoren \textbf{b}.
...
%
\\
Ligningssystemet fra eksempel \ref{eks:lignsys} opskrives som totalmatricen i eksempel \ref{eks:lig_mat}.
%
\begin{eks}\label{eks:lig_mat}
Med udgangspunkt i ligningssystemet fra eksempel \ref{eks:lignsys} følger det at
$$A=
\begin{bmatrix}
1 & 0 & -1 & -2 & -8\\
-2 & 0 & 1 & 2 & 9\\
