...
hvor $\{a_1,a_2,\ldots,a_n\} \in \R$. 
%Er ovenstående korrekt notation? Eller skal der ikke være tuborgklammer om a_1.... osv.?
\begin{defn}{}{linlignsys}
Et \textbf{lineært ligningssystem} er en mængde af $m$ lineære ligninger  med de samme $n$ variabler, hvor $\{m, n\} \in \Z^+$.
...
\text{,}
\end{align*}
hvor $a_{ij}$ betegner koefficienten af $x_j$ i ligning $i$.
\end{defn}
\noindent
...
%Alle ligningerne i systemet repræsenteres af linjer, hvis systemet er i 2 variable, og et plan i 3 variable, osv.
%Ovenstående omskriver jeg til:
Ligninger i $R^2$ repræsenteres af linjer, i $R^3$ repræsenteres de af en plan, og så videre.
...
Med udgangspunkt i eksempel \ref{ekslignsys} kan et lineært ligningssystem opstilles som en matrixligning $A\textbf{x}=\textbf{b}$, hvor
$$A=
\begin{bmatrix}
1 & 0 & -1 & -2 & -8\\
-2 & 0 & 1 & 2 & 9\\
