...
\end{align*}
%
Afhængigt af hvilken pivoteringsregel, som benyttes, er det nødvendigt at udregne alle de mulige reducerede omkostninger, \textcolor{red}{eller i så fald udregne indtil en negativ objektfunktion opstår.}
...
$$\theta^*= \underset{\{i=1,\ldots,m|u_i>0 \} }{\text{min}}  \dfrac{x_{B(i)}}{u_i}.$$
