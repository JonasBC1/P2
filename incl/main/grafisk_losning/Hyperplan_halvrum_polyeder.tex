...
%--------------------
\draw [thick,->] (N) -- (P) node[anchor=south west]{$P$};
\draw [thick, dashed] (N) -- (0.5,-0.3,0.5);
...
\end{tikzpicture}
  \captionof{figure}{Måske den her - Heller ikke sikker}
  \label{fig:mm}
\end{center}
...
% 
\begin{proof}
Lad $\mathbf{x}$ og $\mathbf{x}$ tilhører det samme hyperplan, så er $\mathbf{a}^Tx=\mathbf{a}^Ty.$
