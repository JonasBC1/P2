...
I $\R^2$ vil hyperplanet således være en ret linje, som afskære en del af rummet, og der vil dermed være et halvrum på hver side af hyperplanet, hvilket er illustreret på figur \ref{fig:Graf123}, hvor det øvre halvrum er markeret med blå og det nedre halvrum er markeret med rød. 
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%% Flot graf alla Julie     %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%
%
Hyperplanerne på figur \ref{fig:nej3} danner dermed polygonet og fællesmængden for den øvre halrum udgør polyeden. 
\\\\
%
%
