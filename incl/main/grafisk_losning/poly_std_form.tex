...
\textcolor{red}{Søjlerne $\textbf{A}_{B(1)},\ldots,\textbf{A}_{B(m)}$ kaldes for \textit{basissøjlerne}, og variablerne $x_{B(1)},\ldots,x_{B(m)}$ kaldes for \textit{basisvariablerne}. De resterende søjler i $A$ kaldes derimod \textit{ikke-basale søjler} og de resterende variabler kaldes \textit{ikke-basale variable}. }
