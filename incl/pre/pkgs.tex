...
\usepackage{tikz, pgfplots}                  % generer vektorgrafik med LaTeX-kode
...
\usepackage{listings}			   % directe input af kode
%\usepackage{pgfplots}
...
\usepackage{lmodern}               % Adobe Utopia som primær skrifttype
