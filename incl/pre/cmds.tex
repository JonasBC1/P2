...
\newenvironment{eks}{\bigskip\phantom{.}\newline\noindent\refstepcounter{example}\textbf{Example~\thechapter.\theexample}\phantom{.}\newline\noindent\rule{\textwidth}{0.4pt}}
{\phantom{.}\newline\rule{\textwidth}{0.4pt}}  

\newcounter{proof}[chapter]
\renewenvironment{proof}{\phantom{.}\newline\noindent\refstepcounter{proof}\textbf{Bevis~\thechapter.\theproof}\phantom{.}\newline\noindent}
{\qed}  
